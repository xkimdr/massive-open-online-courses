...
const App = () => {
  ...
  const handleNextAnecdote = () => {
    const newSelected = (selected >= anecdotes.length - 1) ? 0 : selected + 1
    setSelected(newSelected)
  }

  const maxVotes = Math.max(...allVotes)
  const maxVotesSelected = allVotes.indexOf(maxVotes)
  ...
  return (
    <div>
      ...
      <Anecdote anecdote={anecdotes[maxVotesSelected]} />
